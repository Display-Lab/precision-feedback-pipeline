...
class Esteemer():
    ...
    def process_spek(self):
        ...
        # logger.debug(*self.measure_loss_list_new)
        # logger.debug(*self.measure_loss_list)
        ...
        # logger.debug(*self.measure_acheivement_list_new)
        # logger.debug(*self.measure_acheivement_list) 
    ...
    def process_mpm(self):
        ...
        # for k,v in self.gap_dict.items():logger.debug(k, v)
    ...
    def score(self):
        ...
        for i in self.y:
                    ...
                    for s7,p7,o7 in self.spek_tp.triples((s6,ph33,None)):
                        ...
                        if o7==ph5 or o7==ph6:
                            for s7,p7,o7 in self.spek_tp.triples((s6,p4,None)):
                                ...
                                # a_new.append(accept_path)
                                # logger.debug(*a_new)
                                # logger.debug(accept_path)
                                # logger.debug(*a)
                            # logger.debug(*a_full_list)
                            # logger.debug("\n")
            ...
            res1=[res[:]]
            # logger.debug(*res1)
            # logger.debug(*flatlist2)
            # logger.debug(*a_full_list)
            df_a = pd.DataFrame(res1, columns=['Gaps'])
            # logger.debug(df_a.loc[[0]])
            # logger.debug(df_a)
            ...
            # logger.debug(df_a_new.loc[[0]])
            # logger.debug(df_b_new)
            if df_b_new.empty:
                df_merged=df_a_new
        ...
        return self.node,self.spek_tp
        # for k,v in score_dict.items():logger.debug(k, v)
    # # def select(self):
    #     self.scores=[]
    #     nodes=[]
    #     # logger.debug(*self.y)
